...
namespace Lantern\Schema\Values;
...
use Lantern\Execution\Utils\FieldPath;
 ...
 *
 * @phpstan-type Resolver callable(mixed, array<string, mixed>, \Lantern\Support\Contracts\GraphQLContext, \Lantern\Execution\ResolveInfo): mixed
 * @phpstan-type ResolverWrapper callable(Resolver): Resolver
 * @phpstan-type ArgumentSetTransformer callable(\Lantern\Execution\Arguments\ArgumentSet, \GraphQL\Type\Definition\ResolveInfo): \Lantern\Execution\Arguments\ArgumentSet
 */
class FieldValue
{
    /**
     ...
     *     1: \Lantern\Execution\Arguments\ArgumentSet,
     *   }
     * >
     */
