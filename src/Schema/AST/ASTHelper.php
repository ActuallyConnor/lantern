...
use Lantern\Schema\Directives\NamespaceDirective;
use Lantern\Support\Contracts\Directive as DirectiveInterface;
...
class ASTHelper
{
    ...
    /** Directives might have an additional namespace associated with them, @see \Lantern\Schema\Directives\NamespaceDirective. */
